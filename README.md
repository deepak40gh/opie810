...
<div align="center">
  ...
  <!-- Orivion Card -->
  <div style="border: 1px solid #333; border-radius: 10px; width: 300px; padding: 15px; background: #1a1a1a; margin: 10px;">
    ...
    <p><a href="https://github.com/dpokk/orivion" style="color: #1e90ff;">View on GitHub</a></p>
  </div>
  ...
  <div style="border: 1px solid #333; border-radius: 10px; width: 300px; padding: 15px; background: #1a1a1a; margin: 10px;">
    ...
    <p><a href="https://github.com/dpokk/realtime-chatapp" style="color: #1e90ff;">View on GitHub</a></p>
  </div>
...
<details>
  ...
  - **Features:** Scalable architecture, type-safe APIs
...
[![Live](https://img.shields.io/badge/Live-Link-brightgreen?style=for-the-badge&logo=vercel&logoColor=white)](https://orivion.vercel.app)  
